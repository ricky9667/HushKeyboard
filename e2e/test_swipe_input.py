...
options.device_name = 'Pixel_3a_API_34_extension_level_7_arm64-v8a'
options.app = '/Users/ricky9667/Projects/HushKeyboard/app/build/outputs/apk/debug/app-debug.apk'
appium_server_url = 'http://127.0.0.1:4723/wd/hub'


class TestSwipeInput(unittest.TestCase):
    def setUp(self):
    ...
    def test_swipe_input_from_hush_keyboard(self):
        ...
        self.swipe_input_keys()

    def disable_hush_keyboard(self):
        # switch Hush Keyboard to disable
        el = self.driver.find_element(
            by=AppiumBy.XPATH, value='//*[@text="Enable keyboard"]')
        el.click()
        el = self.driver.find_element(
            by=AppiumBy.XPATH, value='//*[@content-desc="Hush Keyboard"]')
        el.click()
    ...
    def enable_hush_keyboard(self):
        ...
        el = self.driver.find_element(
            by=AppiumBy.XPATH, value='//*[@text="OK"]')
        el.click()
        el = self.driver.find_element(
            by=AppiumBy.XPATH, value='//*[@text="OK"]')
        el.click()
    ...
    def turn_on_the_auto_space(self):
        ...
        el = self.driver.find_element(
            by=AppiumBy.XPATH, value='//*[@content-desc="Settings"]')
        el.click()
    ...
    def swipe_input_keys(self):
        el = self.driver.find_element(
            by=AppiumBy.XPATH, value='//*[@text="Type here"]/parent::*')
        el.click()
        ...
        # swipe down R2
        self.driver.swipe(150, 1630, 150, 1700)
        time.sleep(2)
        # swipe left F'
        ...
        self.assertEqual(el.get_attribute('text'), 'R2 F\' D2\' ')
